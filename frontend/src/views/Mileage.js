  ...
  useEffect(async () => {
    ...
    await get(`/mileage`).then((res) => {
      ...
      setmileageDetails((prevState) => ({
        ...prevState,
        name: res[0].customer_first_name,
        Mileageno: res[0].mileage_plus_number,
        Miles: res[0].total_miles,
      }));
    });
  }, []);
  ...
  return (
    <div className="shoe-container mx-auto">
      ...
      <div className="Mileage-form-box">
        ...
        <p>
          Miles never expire{" "}
          <AiFillQuestionCircle style={{ color: "#0d9cdf", fontSize: "20" }} />
        </p>
        {/* <p>
