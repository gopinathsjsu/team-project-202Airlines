    ...
    <form className="flight-book-form">
      <div className="booking-form-box">
        <div className="radio-btn"
          ...
          <input type="radio" className="btn" value="Money" name="bookwith" checked="checked"/><span>Money</span>
          <input type="radio" className="btn" value="Miles" name="bookwith"/><span>Miles</span>
        </div>
