        ...
        <div className="Mileage-form-box">
          ...
          {getFlightsById.map((data, index) => (
            <div>
              ...
              <h5 style={{ marginLeft: '50px', textAlign: 'left' }} typeof={Date}>
              ...
              <h5 style={{ marginLeft: '50px', textAlign: 'left' }}>End Time: {data.end_time}</h5>
              <h5 style={{ marginLeft: '50px', textAlign: 'left' }}>Seats : {data.no_of_seats}</h5>
              <h5 style={{ marginLeft: '50px', textAlign: 'left' }}>Charges : {data.price}</h5>
              <h5 style={{ marginLeft: '50px', textAlign: 'left' }}>
